...
class BeamSearch(object):
    ...
    def apply(
        ...
        with self.model.statefulness(self.b_s):
            for t in range(self.max_len):
                visual, outputs, past, enc_dec_attn_mask = self.iter(
                    t, visual, outputs, past, return_probs, **kwargs
                )
        ...
        if return_probs:
            return outputs, log_probs, all_log_probs, enc_dec_attn_masks
        else:
            return outputs, log_probs, enc_dec_attn_masks
    ...
    def iter(
        ...
        **kwargs
        ...
        word_logprob, past, enc_dec_attn_masks = self.model.step(
            t, self.selected_words, visual, None, past, mode="feedback", **kwargs
        )
        ...
        return visual, outputs, past, enc_dec_attn_masks
